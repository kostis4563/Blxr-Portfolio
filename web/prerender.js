...
const { render, localizedPaths, metaFor, NOT_FOUND_PATH, REVIEW_PANEL_PATH, LOGIN_PATH, DASHBOARD_PATH, PROFILE_BASE_PATH } = await import(
...
const pages = [...localizedPaths(), NOT_FOUND_PATH, REVIEW_PANEL_PATH, LOGIN_PATH, DASHBOARD_PATH, PROFILE_BASE_PATH]
const written = []
